...
public class AuthFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        if (!(authentication instanceof OAuth2Authentication)) {    // 无 token 访问网关内资源的情况，目前仅有 uaa 服务直接暴露
            return null;
        }
        ...
        ctx.addZuulRequestHeader("jsonToken", EncryptUtil.decodeUTF8StringBase64(JSON.toJSONString(jsonToken)));
        return null;
    }
}
