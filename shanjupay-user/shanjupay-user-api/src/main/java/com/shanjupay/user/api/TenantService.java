...
public interface TenantService {
     ...
     * 2.手机号已存在，禁止创建
     * @param createTenantRequestDTO 创建租户请求信息
     * @return
     */
    TenantDTO createTenantAndAccount(CreateTenantRequestDTO createTenantRequestDTO);
     ...
     * @return
     */
    TenantDTO createTenantRelateAccount(CreateTenantRequestDTO createTenantRequestDTO);
     ...
     * @throws BusinessException
     */
    PageVO<TenantDTO> queryTenants(TenantQueryDTO tenantQuery, Integer pageNo, Integer pageSize, String sortBy, String order) throws BusinessException;
     ...
     * @param tenantId 租户id
     */
    void createAccountInTenant(CreateAccountRequestDTO createAccountRequest, Long tenantId) throws BusinessException;
     ...
     * @return
     */
    PageVO<AccountRoleQueryDTO> queryAdministratorByPage(AccountRoleDTO accountRoleDTO, Integer pageNo, Integer pageSize);
