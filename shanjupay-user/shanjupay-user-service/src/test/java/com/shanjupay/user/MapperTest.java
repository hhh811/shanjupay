...
//
//        List<TenantRolePrivilegeDTO> list = authorizationPrivilegeMapper.selectPrivilegeRoleInTenant(roleIds);
///*        Map<String, String[]> temp = new HashMap<>();
//        List<String> tempList = new ArrayList<>();
//        for (TenantRolePrivilegeDTO x : list) {
//            String z = x.getRoleCode() + x.getTenantId();
//            if (tempList.contains(z)) {
//                continue;
//            }
//            List<String> xx = new ArrayList<>();
//            for (TenantRolePrivilegeDTO y : list) {
//
...
//
//    //public static void main(String[] args) {
//    //            /*        [TenantRolePrivilegeDTO(tenantId=1151761810982985002, roleCode=r_002, privilegeCode=p_002),
//    //            TenantRolePrivilegeDTO(tenantId=1151761810982985002, roleCode=r_002, privilegeCode=p_003),
//    //            TenantRolePrivilegeDTO(tenantId=1151761810982985003, roleCode=r_005, privilegeCode=p_005),
//    //            TenantRolePrivilegeDTO(tenantId=1151761810982985003, roleCode=r_005, privilegeCode=p_006)]*/
//    //    List<TenantRolePrivilegeDTO> list = new ArrayList<>();
//    //    for (int i = 0; i <list.size() ; i++) {
//    //        System.out.println(list.get(i));
//    //
//    //    }
