...
public class ResourceController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "privilegeCodes", value = "权限集合", required = true, allowMultiple = true, dataType = "String", paramType = "query"),
    ...
    public List<ResourceDTO> loadResources(@RequestParam List<String> privilegeCodes, @PathVariable String applicationCode) {
        return resourceService.loadResources(privilegeCodes, applicationCode);
    }

    @ApiOperation("获取多个租户下权限所对应的资源信息，并按应用拆分")
    @ApiImplicitParam(name = "tenantAuthorizationInfoMap", value = "多个租户下的资源信息", required = true, dataType = "Map<Long, AuthorizationDTO>", paramType = "body")
