...
public class OauthRepositoryJdbc implements OauthRepository{
    ...
    public void saveOauthClientDetails(OauthClientDetails clientDetails) {
        final String sql = " insert into oauth_client_details(client_id, resource_ids, client_secret, scope, authorized_grant_types, " +
                "web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity, additional_information, trusted, " +
                "autoapprove) values (?,?,?,?,?,?,?,?,?,?,?,?)";
