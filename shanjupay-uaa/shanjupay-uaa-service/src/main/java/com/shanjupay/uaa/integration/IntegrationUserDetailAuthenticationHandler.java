...
import com.shanjupay.uaa.domain.UnifiedUserDetails;
...
import com.shanjupay.user.api.dto.tenant.LoginInfoDTO;
import com.shanjupay.user.api.dto.tenant.LoginRequestDTO;
...
@Slf4j
public class IntegrationUserDetailAuthenticationHandler {
