...
public class RestOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        return ase != null ?
                ...
                this.handleOAuth2Exception(new ServerErrorException((HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase()), e));
    }
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
        ...
        OAuth2Exception oAuth2Exception = new OAuth2Exception(e.getMessage(), e);
        return new ResponseEntity<>(oAuth2Exception, headers, HttpStatus.valueOf(status));
    }
    ...
    private static class MethodNotAllowed extends OAuth2Exception {
        public MethodNotAllowed(String msg, Throwable throwable) {
            super(msg, throwable);
        }
    ...
    private static class ServerErrorException extends OAuth2Exception {
        public ServerErrorException(String msg, Throwable throwable) {
            super(msg, throwable);
        }
